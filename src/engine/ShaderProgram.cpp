...
void ShaderProgram::Build()
{
    ...
    glGetProgramInfoLog(_programId, compilationLogLength, NULL, log.get());
...
bool ShaderProgram::SetUniformFloat(const std::string & name, float val)
{
	std::map<std::string, GLuint>::iterator it = GetIteratorAt(name);
	bool result = false;
...
bool ShaderProgram::SetUniformInteger(const std::string & name, int val)
{
	std::map<std::string, GLuint>::iterator it = GetIteratorAt(name);
	bool result = false;
...
bool ShaderProgram::SetUniformVector(const std::string & name, const glm::vec2 & vec)
{
	std::map<std::string, GLuint>::iterator it = GetIteratorAt(name);
	bool result = false;
...
bool ShaderProgram::SetUniformVector(const std::string & name, const glm::vec3 & vec)
{
	std::map<std::string, GLuint>::iterator it = GetIteratorAt(name);
	bool result = false;
...
bool ShaderProgram::SetUniformVector(const std::string & name, const glm::vec4 & vec)
{
	std::map<std::string, GLuint>::iterator it = GetIteratorAt(name);
	bool result = false;
...
bool ShaderProgram::SetUniformTexture(const std::string & name, Texture* tex, int index)
{
	GLint maxUnits;
...
bool ShaderProgram::SetUniformMatrix(const std::string & name, const glm::mat2 & mat, bool transpose)
{
	std::map<std::string, GLuint>::iterator it = GetIteratorAt(name);
	bool result = false;
...
bool ShaderProgram::SetUniformMatrix(const std::string & name, const glm::mat3 & mat, bool transpose)
{
	std::map<std::string, GLuint>::iterator it = GetIteratorAt(name);
	bool result = false;
...
bool ShaderProgram::SetUniformMatrix(const std::string & name, const glm::mat4 & mat, bool transpose)
{
	std::map<std::string, GLuint>::iterator it = GetIteratorAt(name);
	bool result = false;
