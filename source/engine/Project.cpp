                        ...
                        case ProjectElementTileLongitude:
                            {
                                ...
                                Texture* heightmapData = renderer->CreateMipmapTexture(heightmap, 8);
								...
								if (textureSize == -1 && heightmapSize == -1)
								{
									...
									heightmapSize = heightmapData->GetHeight() * heightmapData->GetWidth() * 2;
								}
                                ...
                                Terrain* terrainTemp = renderer->CreateTerrain(tData, heightmapData, textureData, 8);
